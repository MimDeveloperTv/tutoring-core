...
return [
    ...
    'min'                  => [
        ...
        'alpha_num'  => ':attribute نباید کمتر از :min کاراکتر داشته باشد',
    ],
    ...
    'attributes'           => [
        ...
        "item_per_page"         => 'تعداد آیتم در هر صفحه',
        "date_of_birth"         => 'تاریخ تولد',
        "contact_email" => 'ایمیل',
        "manager_email" => 'ایمیل خصوصی مدیر',
        "slogan" => 'شعار سازمانی',
        "price" => 'قیمت',
        ...
        'part' => 'بخش',
        'quantity' => 'تعداد',
        'types_of_service' => 'عنوان خدمات',
        'part_id' => 'نوع بخش',
    ],
    'error_msg' => 'اطلاعات مورد نیاز به درستی وارد نشده اند'
];
